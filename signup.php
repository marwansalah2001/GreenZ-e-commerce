...
if ($_POST) {
    ...
    $select = "select * from users where name ='$name' or email='$email' or phone ='$phone'";
    $res = $connect->query($select);

    if ($res->num_rows == 0) {
        $insert = "insert into users (name,phone,email,address,password) values ('$name','$number','$email','$address','$password')";
...
<body>
    ...
    <script>
        function validateForm(event) {
            ...
            var password2 = document.getElementsByName("Confirm_Password")[0].value;
            ...
            if (passwordError || emailError) {
                ...
                errorElement.innerHTML = (passwordError ? passwordError + "<br>" : "") + (emailError ? emailError : "");
            } else {
